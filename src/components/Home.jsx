  ...
  return (
    <div>
        <Grid container direction="row" spacing={1} className={classes.mainConteiner}>
            ...
            <Grid item xl={4} md={4} xs={12} sm={12} style={{marginTop: "2em"}}>
                ...
                <Typography variant="h6" color="initial" className={classes.myParagraph}>
                    Hi im Fabricio, a developer and product designer from Ireland. I'm interested in React, Node, Product Design, Jamstack, Startups, Cryptocurrencies and Music.
                </Typography>
                </Grow>
        ...
        <Grid container spacing={1} className={classes.iconLinkContainer}>
            <Grid item>
                <svg fill="#000000" xmlns="http://www.w3.org/2000/svg"  viewBox="0 0 100 100" width="100px" height="100px"><circle cx="50" cy="50" r="34" fill="none" stroke="#ffffff" stroke-miterlimit="10" stroke-width="2"/>
